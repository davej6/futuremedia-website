...
export const metadata: Metadata = {
  title: 'Future Media — Michigan Web Design Studio for Local Businesses',
  description: 'Future Media builds high-converting websites for Michigan plumbers, electricians, HVAC, roofers, and local businesses. Get your FREE mockup today. No payment required.',
